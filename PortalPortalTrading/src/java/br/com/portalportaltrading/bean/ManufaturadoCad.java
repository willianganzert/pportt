...
@ManagedBean
@ViewScoped
public class ManufaturadoCad extends ComunTelas implements ImplementsCad{
    private final Class classePrinciapalCad  = Manufaturado.class;
    private TabelaConfig tabelaConfigPricipalCad;
    /** Creates a new instance of FornecedorCad */
    public ManufaturadoCad() {
        this.sdcTituloTelaCad = UtlMsg.msg("tituloTabela.Manufaturado");
    ...
    public void rowSelectionListener(RowSelectorEvent event) {
        this.tabelaConfigPricipalCad.setSelected(((Manufaturado) this.tabelaConfigPricipalCad.getListaRegistros().get(event.getRow())).clone());
        this.tabelaConfigPricipalCad.setVisablePopupCad(true);
    }

    public String novo() {
        this.tabelaConfigPricipalCad.setSelected(new Manufaturado());
        this.tabelaConfigPricipalCad.setVisablePopupCad(true);
        return "";
    }
    ...
    public String salvar() {
        ...
        {
            JpaAllEntities.insertOrUpdate((Manufaturado)this.tabelaConfigPricipalCad.getSelected());
    ...
    public String excluir() {
        JpaAllEntities.delete((Manufaturado)this.tabelaConfigPricipalCad.getSelected());
        this.tabelaConfigPricipalCad.setVisablePopupCad(false);
