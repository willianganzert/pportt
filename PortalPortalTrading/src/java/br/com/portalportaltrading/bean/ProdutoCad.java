...
public class ProdutoCad extends ComunTelas implements ImplementsCad{
    ...
    /** Creates a new instance of ProdutoCad */
    public ProdutoCad() {
        ...
        colunas.add(new Coluna(UtlMsg.msg("label.Produto.short.snmProduto"), "produto","snmProduto"));
    ...
    public String novo() {
        ...
        produto.setSnmProduto(new Produto());
        this.tabelaConfigPricipalCad.setSelected(produto);
        this.tabelaConfigPricipalCad.setVisablePopupCad(true);
    ...
    public String salvar() {
        if(this.validaDadosClasse(this.tabelaConfigPricipalCad.getSelected()) &&
                this.validaDadosClasse(((Produto)this.tabelaConfigPricipalCad.getSelected()).getEmpresa()))
        {
            ((Produto)this.tabelaConfigPricipalCad.getSelected()).getEmpresa().setNidTipo(1);//TipoFornecedor
            ((Produto)this.tabelaConfigPricipalCad.getSelected()).setNidAtivo(1);
            JpaAllEntities.insertOrUpdate(((Produto)this.tabelaConfigPricipalCad.getSelected()).getEmpresa(),
                    (Produto)this.tabelaConfigPricipalCad.getSelected());
    ...
    public String excluir() {
        JpaAllEntities.delete(((Produto)this.tabelaConfigPricipalCad.getSelected()).getEmpresa(),
                (Produto)this.tabelaConfigPricipalCad.getSelected());
        this.tabelaConfigPricipalCad.setVisablePopupCad(false);
