...
@ManagedBean
@ViewScoped
public class PermissaoCad extends ComunTelas implements ImplementsCad{
    private final Class classePrinciapalCad  = Permissao.class;
    private TabelaConfig tabelaConfigPricipalCad;
    /** Creates a new instance of FornecedorCad */
    public PermissaoCad() {
        this.sdcTituloTelaCad = UtlMsg.msg("tituloTabela.Permissao");
    ...
    public void rowSelectionListener(RowSelectorEvent event) {
        this.tabelaConfigPricipalCad.setSelected(((Permissao) this.tabelaConfigPricipalCad.getListaRegistros().get(event.getRow())).clone());
        this.tabelaConfigPricipalCad.setVisablePopupCad(true);
    }

    public String novo() {
        this.tabelaConfigPricipalCad.setSelected(new Permissao());
        this.tabelaConfigPricipalCad.setVisablePopupCad(true);
        return "";
    }
    ...
    public String salvar() {
        ...
        {
            JpaAllEntities.insertOrUpdate((Permissao)this.tabelaConfigPricipalCad.getSelected());
    ...
    public String excluir() {
        JpaAllEntities.delete((Permissao)this.tabelaConfigPricipalCad.getSelected());
        this.tabelaConfigPricipalCad.setVisablePopupCad(false);
