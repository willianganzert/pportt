...
public class FuncionarioCad extends ComunTelas implements ImplementsCad{
    ...
    public void rowSelectionListener(RowSelectorEvent event) {
        this.tabelaConfigPricipalCad.setSelected(((Funcionario) this.tabelaConfigPricipalCad.getListaRegistros().get(event.getRow())).clone());
        this.tabelaConfigPricipalCad.setVisablePopupCad(true);
    }

    public String novo() {
        this.tabelaConfigPricipalCad.setSelected(new Funcionario());
        this.tabelaConfigPricipalCad.setVisablePopupCad(true);
        return "";
    }
    ...
    public String salvar() {
        ...
        {
            JpaAllEntities.insertOrUpdate((Funcionario)this.tabelaConfigPricipalCad.getSelected());
    ...
    public String excluir() {
        JpaAllEntities.delete((Funcionario)this.tabelaConfigPricipalCad.getSelected());
        this.tabelaConfigPricipalCad.setVisablePopupCad(false);
