...
@ManagedBean
@ViewScoped
public class CaminhaoPedidoCad extends ComunTelas implements ImplementsCad{
    private final Class classePrinciapalCad  = CaminhaoPedido.class;
    private TabelaConfig tabelaConfigPricipalCad;
    /** Creates a new instance of FornecedorCad */
    public CaminhaoPedidoCad() {
        this.sdcTituloTelaCad = UtlMsg.msg("tituloTabela.CaminhaoPedido");
    ...
    public void rowSelectionListener(RowSelectorEvent event) {
        this.tabelaConfigPricipalCad.setSelected(((CaminhaoPedido) this.tabelaConfigPricipalCad.getListaRegistros().get(event.getRow())).clone());
        this.tabelaConfigPricipalCad.setVisablePopupCad(true);
    }

    public String novo() {
        this.tabelaConfigPricipalCad.setSelected(new CaminhaoPedido());
        this.tabelaConfigPricipalCad.setVisablePopupCad(true);
        return "";
    }
    ...
    public String salvar() {
        ...
        {
            JpaAllEntities.insertOrUpdate((CaminhaoPedido)this.tabelaConfigPricipalCad.getSelected());
    ...
    public String excluir() {
        JpaAllEntities.delete((CaminhaoPedido)this.tabelaConfigPricipalCad.getSelected());
        this.tabelaConfigPricipalCad.setVisablePopupCad(false);
